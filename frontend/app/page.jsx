          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-center mb-12">
              <ModernButton variant="primary" size="lg" asChild>
                <Link href={isAuthenticated ? "/dashboard" : "/register"} className="group flex items-center justify-center">
                  <span>{isAuthenticated ? "Go to Dashboard" : "Start Free Trial"}</span>
                  <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </Link>
              </ModernButton>
              <ModernButton variant="glass" size="lg" asChild>
                <Link href={isAuthenticated ? "/labs" : "/register"} className="flex items-center justify-center">
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="group h-full">
                  <div className="p-4 rounded-xl bg-slate-800/30 border border-slate-700/50 hover:border-primary-500/30 transition-all duration-300 h-full flex flex-col">
            ...
            {categories.map((category, index) => {
              ...
              return (
                <div key={index} className="group cursor-pointer">
                  <div className="p-5 rounded-xl bg-slate-800/30 border border-slate-700/50 hover:border-primary-500/30 transition-all duration-300 text-center h-full">
          ...
          <div className="text-center p-8 rounded-xl bg-slate-800/30 border border-slate-700/50">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
              {!isAuthenticated ? (
                <>
                  <ModernButton variant="primary" size="lg" asChild>
                    <Link href="/register" className="group flex items-center justify-center">
